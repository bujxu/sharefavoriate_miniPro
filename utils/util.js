...
function getDecodeEncryptedData(encryptedData, iv, url) {
  ajax({
    "url": url,
    "data": {
...
module.exports = {
  ...
  getDecodeEncryptedData: getDecodeEncryptedData
}
